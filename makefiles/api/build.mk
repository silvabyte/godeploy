...
api.docker.build: ## Build API Docker image for development
	...
	@docker build -t $(DOCKER_IMAGE):$(DOCKER_TAG) -f $(PROJECT_ROOT)/apps/api/Dockerfile $(PROJECT_ROOT)
...
api.docker.build.prod: ## Build API Docker image for production
	...
	@docker build -t $(DOCKER_IMAGE):$(VERSION) -f $(PROJECT_ROOT)/apps/api/Dockerfile $(PROJECT_ROOT)
