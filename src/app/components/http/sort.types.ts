...
export type GenericSortQueryParamValue = (typeof GENERIC_SORT_QUERY_PARAMS)[GenericSortQueryParamKey]
...
export type DeploySortQueryParamValue = (typeof DEPLOY_SORT_QUERY_PARAMS)[DeploySortQueryParamKey]
