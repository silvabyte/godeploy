export function ProjectSkeletonItem() {
	return (
		<li className="group relative flex items-center space-x-4 px-4 py-4 transition-colors sm:px-6">
			...
			<div className="flex items-center gap-2">
				<span className="h-6 w-20 bg-slate-100 rounded-full animate-pulse" />
				<span className="h-8 w-8 bg-slate-100 rounded-full animate-pulse" />
			</div>
		</li>
	);
}
