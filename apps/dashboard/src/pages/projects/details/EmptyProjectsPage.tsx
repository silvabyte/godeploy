			...
			<div className="w-full px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
				<div className="mx-auto max-w-4xl text-center">
					...
					<p className="mx-auto mt-6 max-w-xl text-lg/8 text-pretty text-gray-300">
						Projects are the foundation of your deployments. Create a project to
					...
					<div className="mt-10 text-left">
						<Terminal title="GoDeploy CLI">
							...
							/>
							<TerminalLine
								comment="# 4. Follow the prompts to create your project"
								prompt="$"
								command="? Project name: my-awesome-project"
								delay={1500}
							/>
							<TerminalLine
								prompt="$"
								command="? Project description: My awesome project description"
								delay={2000}
							/>
							<TerminalLine
								prompt="$"
								command="? Subdomain: my-awesome-project"
								delay={2500}
								output="> Project created successfully! 🚀"
							/>
							<TerminalLine
								comment="# 5. Your project will appear on this page"
								delay={3000}
							/>
						</Terminal>
					</div>
					<div className="mt-10 flex items-center justify-center gap-x-6">
						...
						<a
							href="https://github.com/matsilva/godeploy/blob/main/docs/projects.md"
							target="_blank"
